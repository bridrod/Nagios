...
echo "OS_NAME = $OS_NAME \ OS_VERSION = $OS_VERSION \ SERVER = $HOSTNAME \ DELL_MODEL = $DELL_MODEL \ STAG = $STAG \ BIOS_FIRM_VERSION = $BIOS_FIRM_VERSION \ DRAC_VERSION = $DRAC_VERSION \ DRAC_FIRM_VERSION = $DRAC_FIRM_VERSION"
printf "OS_NAME = $OS_NAME \ OS_VERSION = $OS_VERSION \ SERVER = $HOSTNAME \ DELL_MODEL = $DELL_MODEL \ STAG = $STAG \ BIOS_FIRM_VERSION = $BIOS_FIRM_VERSION \ DRAC_VERSION = $DRAC_VERSION \ DRAC_FIRM_VERSION = $DRAC_FIRM_VERSION\n"
...
printf "STAG = $STAG\n"
printf "BIOS_FIRM_VERSION = $BIOS_FIRM_VERSION\n"
printf "DRAC_TYPE = $DRAC_TYPE\n"
printf "DRAC_VERSION = $DRAC_VERSION\n"
printf "DRAC_FIRM_VERSION = $DRAC_FIRM_VERSION\n"
printf "DRAC_BUILD = $DRAC_BUILD\n"
printf "DRAC_NAME = $DRAC_NAME\n"
